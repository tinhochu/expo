...
object ManifestFactory {
  ...
  fun getManifest(manifestJson: JSONObject, headers: Headers, extraAssetHeaders: JSONObject?, configuration: UpdatesConfiguration?): UpdateManifest {
    ...
    return when {
      ...
      Integer.valueOf(expoProtocolVersion) == 0 -> {
        NewUpdateManifest.fromNewManifest(NewManifest(manifestJson), headers, extraAssetHeaders, configuration!!)
      }
      else -> {
